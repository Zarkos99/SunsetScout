...
class SunsetPostCreationActivity : AppCompatActivity() {
    ...
    fun handleCreateNewPost() {
        var new_latitude = m_latitude_input_edit_text.text.toString()
        var new_longitude = m_longitude_input_edit_text.text.toString()
        var new_description = m_description_input_edit_text.text.toString()
